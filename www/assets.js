...
async function loadAssets() {    
    ...
    const initParticleFragSrc = await requestText("assets/shaders/particle_init.frag");
    ...
    particleInitShader = new Shader(gl, texVertSrc, initParticleFragSrc);
